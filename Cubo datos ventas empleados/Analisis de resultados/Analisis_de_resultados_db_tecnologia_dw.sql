...
ventas decimal(10,2) not null,
constraint pk_empleado primary key(idtecnologia))insert into venta_tecnologia values(1,'Computadora', 350.00)insert into venta_tecnologia values(2,'SmartPhone',250.00)insert into venta_tecnologia values(3,'TV',150.00)insert into venta_tecnologia values(4,'Laptop',950.00)insert into venta_tecnologia values(5,'Watch',850.00)